...
class ChecklistController extends Controller
{
    ...
    public function perbaharuiSemuaChecklist(Request $request)
    {
        ...
        return response()->json([
            'message' => 'Anda berhasil centang semua checklist!',
    ...
    public function hapusTitle(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json([
                'message' => 'Anda berhasil menghapus judul checklist!',
            ...
            DB::rollback();
            return response()->json(['message' => 'Anda gagal menghapus judul checklist!']);
        }
    }
    // /Hapus Judul Kartu Admin //
    ...
    public function hapusChecklist(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json([
                'message' => 'Anda berhasil menghapus checklist!',
                'softDeletedTitle' => $softDeletedTitle,
                'softDeletedChecklist' => $softDeletedChecklist,
                'cardId' => $cardId,
            ...
            DB::rollback();
            return response()->json(['message' => 'Anda gagal menghapus checklist!']);
        }
    }
    // /Hapus Checklist Kartu Admin //
    ...
    public function pulihkanJudulChecklist(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json([
                'message' => 'Anda berhasil memulihkan judul checklist!',
                'softDeletedTitle' => $softDeletedTitle,
                'softDeletedChecklist' => $softDeletedChecklist,
                'cardId' => $cardId,
                'titlechecklist' => $titleChecklist,
            ...
            DB::rollback();
            return response()->json(['message' => 'Anda gagal memulihkan judul checklist!']);
        }
    }
    // /Fitur Pemulihan Data Judul Checklist //
    ...
    public function hapusJudulChecklistPermanen(Request $request)
    {
        ...
        if ($titleChecklist) {
            ...
            return response()->json([
                'message' => 'Anda berhasil menghapus judul checklist permanen!',
                'softDeletedTitle' => $softDeletedTitle,
                'softDeletedChecklist' => $softDeletedChecklist,
                'cardId' => $cardId,
                'titlechecklist' => $titleChecklist,
    ...
    public function pulihkanChecklist(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json([
                'message' => 'Anda berhasil memulihkan checklist!',
                'softDeletedTitle' => $softDeletedTitle,
                'softDeletedChecklist' => $softDeletedChecklist,
                'cardId' => $cardId,
                'titlechecklist' => $titleChecklist,
            ...
            DB::rollback();
            return response()->json(['message' => 'Anda gagal memulihkan checklist!']);
        }
    }
    // Fitur Pemulihan Data Checklist //
    ...
    public function hapusChecklistPermanen(Request $request)
    {
        ...
        if ($checklist) {
            ...
            if ($titleChecklist) {
                ...
                return response()->json([
                    'message' => 'Anda berhasil menghapus checklist permanen!',
                    'softDeletedTitle' => $softDeletedTitle,
                    'softDeletedChecklist' => $softDeletedChecklist,
                    'cardId' => $cardId,
                    'titlechecklist' => $titleChecklist,
