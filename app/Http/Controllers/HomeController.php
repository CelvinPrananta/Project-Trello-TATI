...
class HomeController extends Controller
{
    ...
    public function bacaNotifikasi($id)
    {
        if($id)
        {
            ...
            if ($notification) {
                ...
                return response()->json(['message' => 'Anda berhasil membaca notifikasi!'], 200);
            }
        }
        return response()->json(['message' => 'Anda gagal membaca notifikasi'], 500);
    }
    // /Baca Notifikasi Per ID //
    ...
    public function bacasemuaNotifikasi(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json(['success' => 'Anda berhasil membaca semua notifikasi!']);
        }

        return response()->json(['message' => 'Anda gagal membaca semua notifikasi!'], 500);
    }
    // /Baca Semua Notifikasi //
