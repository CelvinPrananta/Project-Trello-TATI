                ...
                <div class="tampilan-kolom gap-4 p-4" id="cardContainer">
                    ...
                    @foreach ($sortedData as $dataKolom)
                        <div class="kolom-card-{{ $dataKolom->id }}" id="kolom-card-{{ $dataKolom->id }}" data-id="{{ $dataKolom->id }}" onmouseenter="aksiKolomShow({{ $dataKolom->id }})" onmouseleave="aksiKolomHide({{ $dataKolom->id }})">
                            ...
                            <ul class="kartu-container" id="containerCard{{ $dataKolom->id }}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="updateColumnForm{{ $dataKolom->id }}" action="{{ route('updateCol', ['board_id' => $board->id, 'team_id' => $board->team_id]) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Nama Kolom</label><span class="text-danger">*</span>
                                    <input type="text" class="form-control @error('column_name') is-invalid @enderror" id="column_name" name="column_name" placeholder="Masukkan nama kolom" value="{{ $dataKolom->name }}" required />
                                    @error('column_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="modal-body">
                                <form id="updateCardForm{{ $dataKartu->id }}" action="{{ route('perbaharuiKartu', ['card_id' => $dataKartu->id]) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $dataKartu->name  }}" placeholder="Masukkan nama kartu" required />
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
