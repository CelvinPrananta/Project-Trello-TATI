...
@section('content')
                ...
                <div class="tampilan-kolom gap-4 p-4" id="cardContainer">
                    ...
                    @foreach ($sortedDataKolom as $dataKolom)
                        <div class="kolom-card hover:scale-105 hover:relative" id="kolom-card-{{ $dataKolom->id }}" data-id="{{ $dataKolom->id }}" onmouseenter="aksiKolomShow({{ $dataKolom->id }})" onmouseleave="aksiKolomHide({{ $dataKolom->id }})">
                            ...
                            <ul class="kartu-container" id="containerCard{{ $dataKolom->id }}" data-id="{{ $dataKolom->id }}">
                            ...
                            <div class="card-trello hidden" id="cardTrello{{ $dataKolom->id }}">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('updateBoard', ['board_id' => $board->id, 'team_id' => $board->team_id]) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('board_name') is-invalid @enderror" id="board_name" name="board_name" placeholder="Masukkan nama papan" value="{{ $board->name }}" required />
                                @error('board_name')
                    ...
                    <div class="modal-body">
                        <form id="addColForm" action="{{ route('addCol', ['board_id' => $board->id, 'team_id' => $board->team_id]) }}" method="POST" onsubmit="addColumnScript(event)">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('column_name') is-invalid @enderror" id="buat-kolom" name="column_name" placeholder="Masukkan nama kolom" required>
                                @error('column_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateColumnForm" method="POST">
                            ...
                            <div class="form-group">
                                <label>Nama Kolom</label><span class="text-danger">*</span>
                                <input type="text" class="form-control" id="update-column-name" name="column_name" placeholder="Masukkan nama kolom" required />
        ...
        <div id="deleteColumn" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-header">
                            <h3>Hapus Kolom "<span id="columnName"></span>"?</h3>
                    ...
                    <div class="modal-body">
                        <form id="updateCardForm" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="update-card-name" name="name" placeholder="Masukkan nama kartu" required />
        ...
        <div id="copyCard" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Salin Kartu</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="copyCardForm" method="POST">
                            ...
                            <div class="form-group">
                                <label for="copy-card-name">Nama Kartu</label><span class="text-danger">*</span>
                                <input type="text" class="form-control" id="copy-card-name" name="name" placeholder="Masukkan nama kartu" required>
                                <span class="invalid-feedback" role="alert" id="copy-card-name-error"></span>
                            </div>
                            <div class="form-group">
                                <label for="keep-checklists">Menyimpan…</label><br>
                                <input type="checkbox" id="keep-checklists" name="keep_checklists" checked>
                                <label for="total-checklists"></label>
                            </div>
                            <div class="submit-section">
                                <button type="submit" class="btn btn-outline-info submit-btn">Buat kartu</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div id="pulihkanKolomModal" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content pulihkan-kartu-modal">
                    <div class="modal-header">
                        <h5 class="modal-title">Pulihkan Kolom</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p class="text-pulihkan">Kolom</p>
        ...
        <div id="pulihkanKartuModal" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content pulihkan-kartu-modal">
                    <div class="modal-header">
                        <h5 class="modal-title">Pulihkan Kartu</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p class="text-pulihkan">Kartu</p>
        ...
        <div id="pulihkanTitleChecklistModal" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content pulihkan-kartu-modal">
                    <div class="modal-header">
                        <h5 class="modal-title">Pulihkan Judul & Ceklist</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p class="text-pulihkan">Judul Checklist</p>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-danger titlechecklist-btn" data-dismiss="modal">Tutup</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="deleteCard" class="modal custom-modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-header">
                            <h3>Hapus Kartu "<span id="cardName2"></span>"?</h3>
                            <p>Apakah anda yakin ingin menghapus kartu ini pada kolom <span id="columnName2"></span>?</p>
                        </div>
                        <div class="modal-btn delete-action">
